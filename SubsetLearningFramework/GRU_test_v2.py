...
# need change
task_index = "3"
train_root = "../tasks/task" + str(task_index) + "/SLF/GRUmodelV2/Fri Apr 29 16_02_44 2022"
train_index = 3
size_bias_root = "../tasks/task" + str(task_index) + "/SizeBias/plan1/Fri Feb 11 21_54_55 2022"
use_size_bias = False
